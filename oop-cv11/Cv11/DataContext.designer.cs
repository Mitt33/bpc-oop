...
namespace Cv11
{
    ...
    partial void DeleteStudentPredmet(StudentPredmet instance);
		...
		public System.Data.Linq.Table<ResultView> ResultViews
		{
			get
			{
				return this.GetTable<ResultView>();
			}
		}
	}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ResultView")]
	public partial class ResultView
	{
		
		private string _Nazev;
		
		private System.Nullable<double> _PrumernaZnamka;
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PrumernaZnamka", DbType="Float")]
		public System.Nullable<double> PrumernaZnamka
		{
			get
			{
				return this._PrumernaZnamka;
			}
			set
			{
				if ((this._PrumernaZnamka != value))
				{
					this._PrumernaZnamka = value;
				}
			}
		}
	}
